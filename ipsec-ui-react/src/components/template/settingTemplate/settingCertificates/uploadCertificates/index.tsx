...
export const UploadCertificates: FC<UploadCertificatesType> = ({ references, onChange, onClick, handleDeleteCerts, noExistCerts }) => (
  <div className={classNames('upload__wrapper', { upload__noCert: noExistCerts })}>
    <Button {...{ onClick: handleDeleteCerts, className: 'upload__cancel' }}>Cancel</Button>
