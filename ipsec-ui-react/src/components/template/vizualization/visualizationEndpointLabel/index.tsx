...
export const VisualizationEndpointLabel: FC<VisualizationEndpointLabelType> = ({ x, y, width, height, text, value, theme }) => {
  const { labelColor, labelColorDark, labelIpColor } = colors;
  ...
  return (
    <Group>
      ...
      <Text {...{ x: x + 5, y, width, height, align: 'start', text: value, verticalAlign: 'middle', fontSize: 14, fontStyle: '400', letterSpacing: 1, fill: labelIpColor }} />
    </Group>
  );
};
