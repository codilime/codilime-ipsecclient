...
module.exports = {
  ...
  plugins: [new webpack.HotModuleReplacementPlugin(), new HtmlWebpackPlugin({ template: './src/index.html', favicon: './public/favicon.ico' }), new CleanWebpackPlugin(), new NodePolyfillPlugin()],
  devServer: {
    https: true,
    proxy: {
